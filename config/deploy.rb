...
set :application, "Ecommerce-Website"
set :repo_url, "https://github.com/Subhan-khaliq/Ecommerce-Website.git"
set :branch, :main #use `git rev-parse --abbrev-ref HEAD`.chomp for pick current branch
set :deploy_to, '/home/deploy/Ecommerce-Website'
set :pty, true
...
set :default_env, { rbenv_bin_path: "~/.rbenv/bin/rbenv" }
